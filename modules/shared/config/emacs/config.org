...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Lacy Morrow"
    user-mail-address "me@lacymorrow.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tmorrow.cont/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tmorrow.cont/bin" "/profile/bin" "/Users/tmorrow.cont/.npm-packages/bin" "/Users/tmorrow.cont/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
